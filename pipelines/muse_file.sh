#!/bin/bash
# Basch script to launch a job with one tumor and normal pair bam file for running MuSE caller. This script was used in a wrapper for running multiple samples on the HPC cluster. 
#SBATCH -N1 -n4 -t 3-0
